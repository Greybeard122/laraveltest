    ...
    <div class="w-full max-w-3xl bg-white bg-opacity-50 backdrop-blur-sm shadow-lg rounded-lg p-8 sm:px-10">
        ...
        <form method="POST" action="{{ route('student.schedules.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="date" id="preferred_date" name="preferred_date" class="form-control w-full" min="{{ date('Y-m-d') }}" required>
            </div>
            ...
            <div>
                ...
                <select id="school_year" name="school_year_id" class="form-control w-full" required>
            ...
            <div>
                ...
                <select id="semester" name="semester_id" class="form-control w-full" required>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (fileDropdown) {
            fileDropdown.addEventListener('change', function () {
                ...
                manualFields.classList.toggle('hidden', !(selectedFileName === 'COR' || selectedFileName === 'COG'));
            });
        }
